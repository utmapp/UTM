    ...
    return @{
        ...
        @"arm":
            @[
                ...
                @"QEMU 5.2 ARM Virtual Machine (alias of virt-5.2)",
                @"Quanta GSJ (Cortex A9)",
                @"Raspberry Pi 2B (revision 1.1)",
                @"Raspberry Pi 2B (revision 1.1) (alias of raspi2b)",
        ...
        @"aarch64":
            @[
                ...
                @"Raspberry Pi 3B (revision 1.2) (alias of raspi3b)",
                @"Raspberry Pi A+ (revision 1.1)",
                @"Raspberry Pi Zero (revision 1.2)",
                @"Samsung NURI board (Exynos4210)",
                @"Samsung SMDKC210 board (Exynos4210)",
        ...
        @"i386":
            @[
                ...
                @"Standard PC (Q35 + ICH9, 2009)",
                @"Standard PC (Q35 + ICH9, 2009)",
                @"Standard PC (Q35 + ICH9, 2009) (alias of pc-q35-5.2)",
                ...
                @"Standard PC (i440FX + PIIX, 1996)",
                @"Standard PC (i440FX + PIIX, 1996)",
                @"Standard PC (i440FX + PIIX, 1996) (alias of pc-i440fx-5.2)",
        ...
        @"ppc64":
            @[
                ...
                @"pSeries Logical Partition (PAPR compliant)",
                @"pSeries Logical Partition (PAPR compliant)",
                @"pSeries Logical Partition (PAPR compliant) (alias of pseries-5.2)",
        ...
        @"s390x":
            @[
                ...
                @"VirtIO-ccw based S390 machine v5.1",
                @"VirtIO-ccw based S390 machine v5.2 (alias of s390-ccw-virtio-5.2)",
                @"VirtIO-ccw based S390 machine v5.2 (default)",
                @"empty machine",
            ],
        @"sh4":
            @[
