    ...
    return @{
        ...
        @"i386":
            @[
                ...
                @"Standard PC (i440FX + PIIX, 1996) (alias of pc-i440fx-6.1) (pc)",
                @"Standard PC (i440FX + PIIX, 1996) (default) (pc-i440fx-6.1)",
        ...
        @"ppc64":
            @[
                ...
                @"generic paravirt e500 platform (ppce500)",
                @"mpc8544ds (mpc8544ds)",
                @"pSeries Logical Partition (PAPR compliant) (alias of pseries-6.1) (pseries)",
                @"pSeries Logical Partition (PAPR compliant) (default) (pseries-6.1)",
        ...
        @"s390x":
            @[
                ...
                @"VirtIO-ccw based S390 machine v6.1 (alias of s390-ccw-virtio-6.1) (s390-ccw-virtio)",
                @"VirtIO-ccw based S390 machine v6.1 (default) (s390-ccw-virtio-6.1)",
                @"empty machine (none)",
            ],
        @"sh4":
            @[
